...
<head>
    ...
    *  $password.gitignore = 'meinPasswort';
    *
    */
   	require_once 'password.gitignore/passwd.inc.php';
   	require_once('DB.php');
   	 ...
   	 * vierter Parameter ist Ihr Passwort (ich habe mein Passwort als Wert der Variablen $password.gitignore
   	 * in der Datei passwd.inc.pwd abgelegt (siehe oben)
   	 */
   $dbh = new DB('_s0553666__mockupdatadb', 'db.f4.htw-berlin.de:3306', 's0553666', $password);
